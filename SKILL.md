---
name: run-ai-media
description: Operate an AI-focused social media account from trend discovery through human-sounding writing, useful visuals, replies, scheduling, publishing, and performance review. Use for AI/tech creator research, X/Twitter posts, quote posts, hot-topic replies, content calendars, Build in Public updates, practical tutorials, social-card briefs, or requests to remove generic AI-writing patterns.
---

# Run AI Media

Build an account people follow for judgment and lived experience, not a news-feed clone.

## Load the account context
...
1. **Verify the topic**
   - For live topics, inspect the official announcement and at least one independent reaction.
...
- 30% practical workflows and tutorials
- 25% current AI releases with an original angle
- 20% Build in Public and product evidence
- 15% comparisons, failures, and costs
- 10% developer jokes and personal observations

Do not publish more because inventory exists. Publish when the post has evidence, usefulness, or entertainment.